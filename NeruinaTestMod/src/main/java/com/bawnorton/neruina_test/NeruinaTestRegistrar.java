...
public class NeruinaTestRegistrar {
    ...
    public static final Block CRASHING_BLOCK = Registry.register(Registries.BLOCK, NeruinaTest.id("crashing_block"), new CrashingBlock(FabricBlockSettings.create()));
    public static final Block CRASHING_RANDOM_TICK_BLOCK = Registry.register(Registries.BLOCK, NeruinaTest.id("crashing_random_tick_block"), new CrashingRandomTickBlock(FabricBlockSettings.create().ticksRandomly()));
    ...
    private static final RegistryKey<ItemGroup> ITEM_GROUP = RegistryKey.of(RegistryKeys.ITEM_GROUP, NeruinaTest.id("items"));
